...
<div class="content inside-page payment">
        ...
        <div class="breadcrumb"><a href="index.html">首页</a> / 订单确认</div>
       <fieldset>
		<div class="form-horizontal content-center">		
		<form action="checkoutAction" class="com.xyz.action.PersonAction" method="post" onsubmit="return myfun_submit()">
				
				
				<div class="form-group">
				<label for="inputEmail3" class="col-sm-4 control-label" >电话号码</label>
				<div class="col-sm-8">
				<input type="text" class="form-control" name="celphone" value="${sessionScope.user.userCelphone}">
				</div>				
				</div>
				...
				<div class="col-sm-8">
				<input type="text" class="form-control" name="address" value="${sessionScope.user.userAddress}">
				</div>				
				</div>			


				<s:actionerror/>
				<input type="submit"  value="提交" name="register" class="btn btn-primary"/>
