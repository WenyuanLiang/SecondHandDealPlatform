...
<div class="content inside-page login">
		...
		<div class="row">
			<div class="col-sm-6">
				<h3><font size=6>登录</font></h3>
				<form action="login" class="com.xyz.action.LoginAction" method="post">
				<div class="form-group">
				<label for="exampleInputEmail1">登录名</label>
				<input type="text" class="form-control" name="userName" placeholder="输入登录名">
				</div>
				<div class="form-group">
			...
			<div class="col-sm-6">
			<h3><font size=6>账户注册</font></h3>
			<p>立即注册夏衣族旧货市场账户，更多优惠享不停！ </p>
		...
		<hr>
		<a href="index.jsp" class="btn btn-primary pull-left">返回首页</a>
