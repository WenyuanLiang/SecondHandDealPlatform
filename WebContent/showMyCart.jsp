...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <% if ((String)request.getAttribute("addtocart") == "success") { %>
 <script>
 alert("加入成功！");
 </script>
 <%} %>
 <% if ((String)request.getAttribute("addtocart") == "false") { %>
 <script>
 alert("购物车中已存在！");
 </script>
 <%} %>
...
<c:if test="${empty requestScope.load }">
	<jsp:forward page="showMyCartAction"></jsp:forward>
</c:if>
...
<div class="shopping-cart">
	<!-- fieldsets -->
            ...
            <hr>
            	...
            	<div class="col-xs-2 col-sm-1 center"><a href="deleteMyCartAction?goodsId=${goods.goodsId}"><i class="fa fa-close"></i></a></div>
          	</div>
</c:forEach>	
...
<hr>
    ...
    <a href="payment.jsp" class="btn btn-primary pull-right">现在购买</a>
