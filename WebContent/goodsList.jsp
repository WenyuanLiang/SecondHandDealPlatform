...
<div class="content inside-page collection">
       ...
       <h2 class="title">商品列表</h2>
        ...
        <div class="breadcrumb"><a href="index.jsp">主页</a> / 搜索结果</div>
       		...
       		<c:forEach items="${requestScope.goodsList }" var="goods">
       			<div class="col-sm-2 col-xs-6">
	                <div class="product">
	                     ...
	                     <a href="addToCartByUserAndGoods?goodsId=${goods.goodsId }" class="btn btn-default"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
	                </div>
            	</div>
       		</c:forEach>
