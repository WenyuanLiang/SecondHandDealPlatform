...
<div class="content inside-page register" id="registerdiv">
		...
		<div class="form-horizontal content-center">
				...
				<form action="infochange" class="com.xyz.action.LoginAction" method="post" onsubmit="return myfun_submit()">
				<div class="form-group">
				...
				<div class="col-sm-8">
				<input type="password" class="form-control" name="userPassword" value="${sessionScope.user.userPassword}">
				</div>				
				</div>
				
				<div class="form-group">
				<label for="inputEmail3" class="col-sm-4 control-label" >电话号码</label>
				<div class="col-sm-8">
				<input type="text" class="form-control" name="userCelphone" value="${sessionScope.user.userCelphone}">
				</div>				
				</div>
				...
				<div class="col-sm-8">
				<input type="text" class="form-control" name="userAddress" value="${sessionScope.user.userAddress}">
				</div>				
				</div>			


				<s:actionerror/>
				<input type="submit"  value="完成" name="register" class="btn btn-primary"/>
<!-- <div class="col-sm-8 col-sm-offset-4"><a href="login.jsp" class="btn btn-primary pull-left">立即注册</a></div> -->
