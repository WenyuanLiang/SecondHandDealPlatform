...
<div class="content inside-page collection">
       ...
       <div class="pull-right sortby">
         <a href="addMyGoods.jsp" class="btn btn-default">
         <i class=""></i> 上架新商品</a>
       </div>
       ...
       <h2 class="title">${requestScope.title}</h2>
          ...
          <div class="breadcrumb"><a href="index.html">首页</a> / 我的商品</div>
       <div class="row">
       <c:forEach items="${requestScope.goodslist}" var="goods">
            <div class="col-sm-2 col-xs-6">
                <div class="product">
                            ...
                            <a href="deleteMyGoodsAction?goodsId=${goods.goodsId}" class="btn btn-default"><i class="fa fa-shopping-cart"></i> 下架</a>
                </div>
            </div>
            </c:forEach>	
        </div>
