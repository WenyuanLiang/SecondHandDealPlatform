...
<div class="content inside-page register" id="registerdiv">
		...
		<div class="form-horizontal content-center">
				...
				<form action="register" class="com.xyz.action.LoginAction" method="post" onsubmit="return myfun_submit()">
				<div class="form-group">
				...
				<div class="col-sm-8">
				<input type="text" class="form-control" name="userCelphone">
				</div>				
				</div>
				...
				<s:actionerror/>
				<input type="submit"  value="注册" name="register" class="btn btn-primary"/>
