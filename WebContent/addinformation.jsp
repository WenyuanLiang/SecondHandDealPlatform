...
<!-- checkout -->
<div class="content inside-page register" align="center">
        <h1 class="title" align="center">添加购物信息</h1>
        ...
        <fieldset>
        <form action="buyNowAction?goodsId=<%=id%>" method="post">
		...
		<div class="form-horizontal content-center">
				...
				<div class="col-sm-8">
					...
					<input type="radio" name="inlineRadioOptions">男
					</label>
					<label class="radio-inline">
					<input type="radio" name="inlineRadioOptions">女
					</label>
				</div>
				...
				<div class="form-group">
				<label for="inputEmail3" class="col-sm-4 control-label">快递</label>
				<div class="col-sm-8">
				...
				<div class="col-sm-8">
				<input type="text" class="form-control" name="orderCelphone">
				</div>				
				</div>
			...
			<input type="submit" class="btn btn-primary pull-left" value="确认信息无误，购买"></a></div>
